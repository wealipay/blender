...
export declare function getSegmentKeypath(fetchStrategy: FetchStrategy, route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): Prefix<SegmentCacheKeypath>;
